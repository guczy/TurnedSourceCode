...
public class ShootingAk : MonoBehaviour
{
    ...
    void Start()
    {
        // Ensure player with AK tag is correctly set up in the scene
        GameObject playerWithAkModel = GameObject.FindGameObjectWithTag("Player AK");

        if (playerWithAkModel == null)
        {
            Debug.LogError("Player AK GameObject not found!");
        }
    }
